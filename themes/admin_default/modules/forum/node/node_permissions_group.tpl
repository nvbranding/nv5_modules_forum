...
<div id="forum-content"> 
	<div class="titleBar">
		<h1>Cấp quyền mục: {NODE_TITLE} - {GROUP_TITLE}</h1>	
	</div>
	<form action="{ACTION}" class="xenForm formOverlay PermissionChoices" id="PermissionChoices" method="post">
			...
			<table class="permissions" id="pg_{interfaceGroup.key}">
				<tbody>
					...
					<tr class="permission">
						...
						$('.{PERMISSION.permission_type} input[type="radio"]').on('click', function(){
		...
		<dl class="ctrlUnit submitUnit"><dt></dt>
			<dd>
				...
				<button class="btn btn-primary" type="button" id="submitform"><i class="fa fa-spinner fa-lg fa-spin" style="display:none"></i> Cập nhật quyền </button>
