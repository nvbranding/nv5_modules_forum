...
<div id="users">
    ...
    <form id="loginForm" action="{USER_LOGIN}" method="post" class="form-inline register1 clearfix">
        ...
        <div class="clearfix rows">
            ...
            <input type="password" id="password_iavim" name="nv_password" value="{DATA.nv_password}" class="form-control required password" maxlength="{PASS_MAXLENGTH}" />
        </div>
        <!-- BEGIN: captcha -->
        <div class="clearfix rows">
            <label>
