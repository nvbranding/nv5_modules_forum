...
<form class="form-inline" action="{USER_LOGIN}" method="post">
    <div class="block-login">
        <div class="box clearfix">
            <input id="block_login_iavim" name="nv_login" type="text" class="form-control input fl" maxlength="{NICK_MAXLENGTH}" onblur="if(this.value=='')this.value='{LANG.username} ';" onclick="if(this.value=='{LANG.username} ')this.value='';" value="{LANG.username} " /><input id="block_password_iavim" type="password" name="nv_password" value="" class="form-control input fr" maxlength="{PASS_MAXLENGTH}" />
        </div>
        <!-- BEGIN: captcha -->
            <div class="box clearfix">
                <input id="block_seccode_iavim" name="nv_seccode" type="text" class="form-control input fl" maxlength="{GFX_MAXLENGTH}" onblur="if(this.value=='')this.value='{LANG.securitycode}';" onclick="if(this.value=='{LANG.securitycode}')this.value='';" value="{LANG.securitycode}" />
