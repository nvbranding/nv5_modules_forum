...
<div id="users">
    ...
    <form id="registerForm" action="{USER_REGISTER}" method="post" class="form-inline box-border-shadow content-box clearfix reg">
            <dl class="clearfix ">
                <dt class="fl">
                    <label>
                        {LANG.name}
            ...
            <dl class="clearfix">
                ...
                <dd class="fr">
                    <input class="form-control input required password" name="password" value="{DATA.password}" id="nv_password_iavim" type="password" maxlength="{PASS_MAXLENGTH}" autocomplete="off"/>
                </dd>
            </dl>
            <dl class="clearfix ">
                <dt class="fl">
                ...
                <dd class="fr">
                    <input class="form-control input required password" name="re_password" value="{DATA.re_password}" id="nv_re_password_iavim" type="password" maxlength="{PASS_MAXLENGTH}" autocomplete="off"/>
                </dd>
            </dl>
            <dl class="clearfix">
                <dt class="fl">
