...
<div id="users">
    ...
    <form id="loginForm" action="{OPENID_LOGIN}" method="post" class="form-inline register1 clearfix">
        <div>
        ...
        <div class="clearfix rows">
            ...
            <input type="password" id="password_iavim" name="password" value="" class="form-control required password" />
        </div>
        <!-- BEGIN: captcha -->
        <div class="clearfix rows">
            <label>
