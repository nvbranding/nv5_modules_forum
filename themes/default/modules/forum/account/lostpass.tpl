...
<div id="users">
    ...
    <form id="lostpassForm" class="form-inline box-border-shadow clearfix content-box" action="{FORM1_ACTION}" method="post">
        <h5>
            {DATA.info}
        </h5>
        <fieldset>
    ...
    <form id="lostpassForm" class="form-inline box-border-shadow clearfix content-box" action="{FORM2_ACTION}" method="post">
        <p>
