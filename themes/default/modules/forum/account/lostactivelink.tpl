...
<div id="users">
    ...
    <form id="lostpassForm" class="form-inline register1 clearfix" action="{FORM1_ACTION}" method="post">
    ...
    <!-- END: step1 -->
    <!-- BEGIN: step2 -->
    <form id="lostpassForm" class="form-inline register1" action="{FORM2_ACTION}" method="post">
        <div class="info padding_0" style="padding-top:10px;padding-bottom:10px;">
            <strong>{DATA.info}</strong>
        </div>
