...
<div id="users">
    ...
    <form id="loginForm" action="{USER_LOGIN}" method="post" class="form-inline box-border-shadow content-box clearfix">
		<p>
                {LANG.login_info}
        </p>
		<div class="fl login"> 	
            ...
            <div class="clearfix r2">
                ...
                <input type="password" id="password_iavim" name="nv_password" value="{DATA.nv_password}" class="form-control required password input" maxlength="{PASS_MAXLENGTH}" />
            </div><!-- BEGIN: captcha -->
            <div class="clearfix r2">
                <label>
                    {LANG.captcha}
