			...
			$('#file_upload').uploadifive({
				...
				'onUploadComplete' : function(file, data) { 
					...
					if(message == 'success')
					{
						...
						a+="		<input type=\"button\" onclick=\"removeimg( "+items['attachment_id']+", "+items['data_id']+" )\"  value=\"{GLANG.delete}\" class=\"button smallButton AttachmentDeleter\" style=\"display: block;\">";
						a+="	  </div>";
						a+="	</div>";
						a+="</li>";
                ...
                <li id="attachment{attach.attachment_id}" rel="{attach.checkss}" class="AttachedFile  secondaryContent AttachedImage" style="opacity: 1;">
                  ...
                  <div class="AttachmentText" style="">
                    ...
                    <div class="controls">
                      ...
                      <input type="button" onclick="removeimg({attach.attachment_id},{attach.data_id})" value="{GLANG.delete}" class="button smallButton AttachmentDeleter" style="display: block;">
                      </div>
                  </div>
                </li>
                <!-- END: attachments -->
